...
StyledItem {
    ...
    /*!
      ...
      \table
        ...
        \li {2, 1} Time picker modes
            ...
            \row
                \li FiveMinutes
                \li Specifies to show a minute picker in five minute intervals
            \row
                \li Minutes
      ...
      \a{Months|Days}, \a{Hours|FiveMinutes|Seconds}, \a{Hours|Minutes|Seconds}, \a{Hours|FiveMinutes}, \a{Hours|Minutes}, \a{FiveMinutes|Seconds}, and \a{Minutes|Seconds},
    ...
    FiveMinutesModel {
        id: fiveMinutesModel
        mainComponent: datePicker
        pickerCompleted: internals.completed && internals.showFiveMinutesPicker
        pickerWidth: {
            if (!pickerItem) {
                return 0;
            }
    ...
    Binding {
        ...
        value: (internals.showHoursPicker || internals.showFiveMinutesPicker || internals.showMinutesPicker || internals.showSecondsPicker) ?
                   ":" : ""
    }
    ...
    QtObject {
        ...
        property bool showFiveMinutesPicker: false
        ...
        function updatePickers() {
            if (completed) {
                ...
                showHoursPicker = showFiveMinutesPicker = showMinutesPicker = showSecondsPicker = false;
                ...
                if(showFiveMinutesPicker && showMinutesPicker) {
                ...
                if (showHoursPicker && showSecondsPicker && !(showMinutesPicker || showFiveMinutesPicker)) {
                    console.warn("Invalid DatePicker mode: " + datePicker.mode);
                    return;
                }
                ...
                if ((showYearPicker || showMonthPicker || showDayPicker) &&
                        (showHoursPicker || showFiveMinutesPicker || showMinutesPicker || showSecondsPicker)) {
        ...
        function arrangeTumblers() {
            ...
            if (showFiveMinutesPicker) {
                tumblerModel.setPickerModel(fiveMinutesModel, "FiveMinutesPicker", formatIndex);
                formatIndex++;
            } else {
                tumblerModel.removePicker("FiveMinutesPicker");
            }
