...
class TestMainWindow(CalendarTestCase):
    ...
    def test_timeline_view_shows(self):
        event_view = lambda: self.main_window.get_event_view().eventViewType

        self.ubuntusdk.click_toolbar_button('Timeline')
        self.assertThat(event_view, Eventually(Equals("TimeLineView.qml")))
        self.ubuntusdk.click_toolbar_button('Diary')
        self.assertThat(event_view, Eventually(Equals("DiaryView.qml")))
        self.ubuntusdk.click_toolbar_button('Timeline')
        self.assertThat(event_view, Eventually(Equals("TimeLineView.qml")))
