...
class TestMainWindow(CalendarTestCase):
    ...
    def changeMonth( self, direction = True, count = -1):
    ...
    def test_monthview_today(self, direction = True, count = -1):
        if count == -1 :
            return
        ...
        self.changeMonth(direction,count) 
    ...
    def test_monthview_change_month(self, direction = True, count = -1):
